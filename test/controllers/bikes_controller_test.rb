...
class BikesControllerTest < ActionController::TestCase
  ...
  test "should create bike" do
    assert_difference('Bike.count') do
      post :create, bike: { description: @bike.description, price: @bike.price, status: @bike.status, title: @bike.title }
    end
  ...
  test "should update bike" do
    patch :update, id: @bike, bike: { description: @bike.description, price: @bike.price, status: @bike.status, title: @bike.title }
    assert_redirected_to bike_path(assigns(:bike))
  end
